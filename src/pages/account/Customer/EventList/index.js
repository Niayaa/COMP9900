        ...
        {Bookevents.map((event) => (
          <div key={event.id} className="event-card">
            ...
            <div className="event-actions">
              ...
              <button id={event.id} className="book" onClick={handlePopupBookInfo}>Booked info</button>
              <BookInfoPopUp open={openI} handleClose={handleCloseBookInfo} id={event.id}></BookInfoPopUp>
